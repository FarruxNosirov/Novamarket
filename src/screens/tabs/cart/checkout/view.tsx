...
const CheckoutView = () => {
  ...
  const effect = async () => {
    try {
      ...
      setUser({
        ...user,
        phone: res3.data.data.phone,
        email: res3.data.data.email,
        name: res3.data.data.name,
        lastName: res3.data.data.lastName || "",
      });
      setState({
        ...state,
        name: res3.data.data.name,
                ...
                return (
                  <>
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        setIsActive2(i),
                          setState({ ...state, payment_id: item.id });
                      }}
                    >
                      <View
                        style={
                      ...
                      >
                        <View
                          style={
                            activeIndex2 === i ? styles.activeDot : styles.dot
                          }
                        ></View>
                      </View>
                      <View
